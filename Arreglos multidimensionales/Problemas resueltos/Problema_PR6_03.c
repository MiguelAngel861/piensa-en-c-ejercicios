/* Escribe un programa en C que intercambie las N columnas de un arreglo bidimensional.
 * Los elementos de la primera columna se intercambian con los de la última, los de la
 * segunda con los de la penúltima, y así sucesivamente.
 * 
...
void Intercambia(float A[][MAX], int F, int C)
{
         ...
         * bidimensional. Observa que el índice correspondiente a las columnas 
         * sólo se mueve hasta la mitad del arreglo. 
         */

        int I, J;
        float AUX;
        
        /* Observa que en esta función el índice I se utiliza para las columnas, 
         * y el índice J para las filas. 
         */
...
{
        /* La función Imprime se utiliza para escribir un arreglo 
         * bidimensional de tipo real de F filas y C columnas. 
         */
