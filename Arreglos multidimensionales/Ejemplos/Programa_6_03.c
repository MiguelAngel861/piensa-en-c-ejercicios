 ...
 * han ingresado a sus ocho diferentes carreras en los dos semestres lectivos,
 * en los últimos cinco años. Escribe un programa en C que calcule lo siguiente:
 *
 ...
 *          número de alumnos?
 * 
 * Dato: UNI[8][2][5] (arreglo tridimensional de tipo entero que almacena
...
void main(void)
{
        ...
        Funcion1(UNI, F, C, P);
        Funcion2(UNI, F, C, P);
        Funcion3(UNI, 6, C, P); /* Se coloca el 6 como parámetro ya que es la clave de la Ingeniería en Computación. */
