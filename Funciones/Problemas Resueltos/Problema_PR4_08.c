/* 
 *                           Lluvias.
 * El programa permite calcular el promedio mensual de las lluvias 
 * caídas en tres regiones importantes del país. Determina también 
 * cuál es la región con mayor promedio de lluvia anual. 
 */
