 ...
 * de tipo entero, desordenados, de N y M elementos respectivamente, genere un nuevo arreglo
 * unidimensional ordenado en forma descendente de N+M elementos de tipo entero, mezclando
 * los dos primeros arreglos.
 * 
 * Datos: VEC1[N], VEC2[M]
 * 
...
int main(void) 
{
        ...
        printf("\nArreglo numero tres ordenado en forma descendente:\n");
        for (int i = 0; i < O; i++) {
                printf("%d ", VEC3[i]);
        }
